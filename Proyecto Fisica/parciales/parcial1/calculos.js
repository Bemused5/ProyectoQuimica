...
function verificarRespuestas() {
  ...
  let r6 = document.getElementById("respuesta-6").value;
  let r7 = document.getElementById("respuesta-7").value;
  let r8 = document.getElementById("respuesta-8").value;
  ...
  resultado += parseInt(r6);
  resultado += parseInt(r7);
  resultado += parseInt(r8);
}
